...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    contactPosition: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    officiateContact: Schema.Attribute.String;
    officiatePhone: Schema.Attribute.String;
...
export interface ApiEntryEntry extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::entry.entry'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    refund: Schema.Attribute.String;
    shirts: Schema.Attribute.Blocks;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiGameGame extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    away_team_score: Schema.Attribute.Integer;
    coaches: Schema.Attribute.Relation<'manyToMany', 'api::coach.coach'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date: Schema.Attribute.Date;
    fallback_winner: Schema.Attribute.Relation<'oneToOne', 'api::team.team'>;
    home_team: Schema.Attribute.Relation<'manyToOne', 'api::team.team'>;
    home_team_score: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    overtime: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiMetaMeta extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    cancelNote: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPlayerPlayer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    freethrow_winners: Schema.Attribute.Relation<
      'oneToMany',
      'api::tournament.tournament'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiSpreadsheetSpreadsheet extends Struct.SingleTypeSchema {
  collectionName: 'spreadsheets';
  info: {
    displayName: 'spreadsheet';
    pluralName: 'spreadsheets';
    singularName: 'spreadsheet';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    lodging: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiStatementStatement extends Struct.SingleTypeSchema {
...
export interface ApiTeamTeam extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    away_games: Schema.Attribute.Relation<'oneToMany', 'api::game.game'>;
    coaches: Schema.Attribute.Relation<'manyToMany', 'api::coach.coach'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    home_games: Schema.Attribute.Relation<'oneToMany', 'api::game.game'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::spreadsheet.spreadsheet': ApiSpreadsheetSpreadsheet;
